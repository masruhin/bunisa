...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="../vendors/app-assets/css/plugins/forms/form-validation.css">
  <link rel="stylesheet" type="text/css" href="../vendors/app-assets/css/pages/page-auth.css">
  <!-- END: Page CSS-->
        ...
        <div class="auth-wrapper auth-v2">
          <div class="auth-inner row m-0">
            ...
            <div class="d-none d-lg-flex col-lg-8 align-items-center p-5">
              <div class="w-100 d-lg-flex align-items-center justify-content-center px-5"><img class="img-fluid" src="../vendors/app-assets/images/pages/login-v2.svg" alt="Login V2" /></div>
            </div>
            <!-- /Left Text-->
            <!-- Login-->

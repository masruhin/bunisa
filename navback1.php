  ...
  <ul class="nav navbar-nav" id="main-menu-navigation" data-menu="menu-navigation">
    ...
    while ($r = $ada->fetch_object()) {
      ...
      if ($adasub->num_rows > 0) {
        echo '<li class="dropdown nav-item" data-menu="dropdown">
                  <a class="dropdown-toggle nav-link d-flex align-items-center" href="#" data-toggle="dropdown">
                    <i data-feather="' . $r->icon . '"></i><span>' . $r->nama_modulutama . '</span>
                  </a>
                  <ul class="dropdown-menu">';
        while ($w = $adasub->fetch_object()) {
          echo '<li data-menu="">
                      <a href="' . $w->link . '" class="dropdown-item d-flex align-items-center" data-toggle="dropdown" data-i18n="Documentation" target="_blank">
    ...
    <!-- <li class="dropdown nav-item" data-menu="dropdown">
      <a class="dropdown-toggle nav-link d-flex align-items-center" href="#" data-toggle="dropdown">
        <i data-feather="box"></i><span>Misc</span>
      </a>
      <ul class="dropdown-menu">
        <li data-menu="">
